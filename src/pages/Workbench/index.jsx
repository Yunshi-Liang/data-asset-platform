...
function Workbench(){
 ...
 return <div className="workbench-page">{modalContextHolder}<div className="page-header workbench-title"><div className="page-header-copy"><Typography.Title className="page-header-title" level={3}>个人工作台</Typography.Title><Typography.Text className="page-header-description">集中查看数据收藏、使用申请、待办审批及个人经手的数据资产。</Typography.Text></div></div><WorkbenchOverview favorites={favorites.length} applications={processingCount} pendingApprovals={pendingCount} completedApprovals={completed} handledProductCount={handledProducts.length}/><Card className="workbench-tabs"><Tabs activeKey={activeTab} onChange={setActiveTab} items={tabItems}/></Card>
