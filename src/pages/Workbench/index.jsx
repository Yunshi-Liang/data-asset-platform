...
function Workbench(){
 ...
 const tabItems=[
  ...
  {key:'applications',label:`我的申请 ${applications.length}`,children:<MyApplications data={applications} highlightId={highlightId} onView={setApplicationDetail} onWithdraw={withdraw} onReapply={setApplicationProduct} onAccess={record=>message.success(`${record.method}权限可用，当前为 Demo 模拟入口`)}/>},
